...
import { AdaptiveTuningState, ExperienceMetricsSnapshot, LearningStreak } from './storage';
import {
  CEFR_LEVELS,
  LEVELS,
  MAX_CUSTOM_PROFILES,
...
import { getThemeModeLabel } from './ui-theme';
      ...
      <article className="panel stack stagger-enter" data-index="3">
        ...
        {!isBuiltinActive && (
          <div className="field">
            ...
            />
            <button type="button" className="btn warn" onClick={onDeleteCurrentCustomProfile}>
              删除当前自定义档
            </button>
          </div>
        )}
